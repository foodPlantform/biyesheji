        ...
        [rev reverseGeocodeLocation:location completionHandler:^(NSArray<CLPlacemark *> * _Nullable placemarks, NSError * _Nullable error) {
            ...
            }else
            {
                ...
                [alertController addAction:[UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
                    ...
                    //确定按钮的点击事件
                    if ([_delegate respondsToSelector:@selector(KCMainViewControllerLongProessGetLoaction:)]) {
                        [_delegate KCMainViewControllerLongProessGetLoaction:firstPlacemark.name];
